...
```
    ...
    <ipython-input-9-2055223f6094> in <module>
    ----> 1 np.array(rank_2_tensor)
...
```
    ...
    <ipython-input-8-ab960f406daa> in <module>
    ----> 1 rank_2_tensor.numpy()
    

    NameError: name 'rank_2_tensor' is not defined
